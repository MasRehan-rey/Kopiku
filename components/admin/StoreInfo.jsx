    ...
    return (
        <div className="flex-1 space-y-2 text-sm">
            <Image 
                ...
                onError={(e) => {
                    e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(store.name)}&background=random&size=100`
                }}
            />
            ...
            <div className="flex items-center gap-2 text-sm ">
                <Image 
                    ...
                    onError={(e) => {
                        e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(store.user.name)}&background=random`
                    }}
                />
                <div>
