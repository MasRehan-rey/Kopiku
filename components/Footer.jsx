    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Kebijakan Privasi", path: '/', icon: null },
                { text: "Berlangganan Member", path: '/pricing', icon: null },
                { text: "Daftar Cafe", path: '/create-store', icon: null },
            ]
        },
        {
            title: "KONTAK",
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                           <span className="text-[#6B4F3A]">Kopi</span>kita
                           <span className="text-[#6B4F3A] text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Selamat datang di KopiKita — website terbaik untuk menikmati pengalaman ngopi yang lebih praktis dan modern.
Mulai dari memesan kopi favorit, mencari rekomendasi menu, hingga memantau promo dan loyalty point, semuanya bisa kamu lakukan dalam satu website.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © kopikita All Right Reserved.
                </p>
            </div>
        </footer>
    );
